...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.riguz.encryptions.EncryptionsPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin encryptions, com.riguz.encryptions.EncryptionsPlugin", e);
    }
    try {
