    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                mTracker.addMovement(event);
                if (null != mOnWheelChangeListener)
//                    mOnWheelChangeListener.onWheelScrolled(SCROLL_STATE_DRAGGING);
...
//                mOnWheelChangeListener.onWheelScrolled(SCROLL_STATE_IDLE);
            }
        }
        if (mScroller.computeScrollOffset()) {
            if (null != mOnWheelChangeListener)
                mOnWheelChangeListener.onWheelScrollStateChanged(SCROLL_STATE_SCROLLING);
//                mOnWheelChangeListener.onWheelScrolled(SCROLL_STATE_SCROLLING);
