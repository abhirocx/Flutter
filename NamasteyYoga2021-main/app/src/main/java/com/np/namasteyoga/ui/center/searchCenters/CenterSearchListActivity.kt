package com.np.namasteyoga.ui.center.searchCenters
...
import com.np.namasteyoga.ui.center.centerDetails.CenterDetailsDialogFragment
import com.np.namasteyoga.ui.center.searchCenters.adapter.CenterListAdapter
...
class CenterSearchListActivity : BaseActivity<CenterSearchListViewModel>(
    CenterSearchListViewModel::class
),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lstTrainerSearch.run {
            layoutManager = LinearLayoutManager(this@CenterSearchListActivity)
            adapter = CenterListAdapter(
                list,
                this@CenterSearchListActivity,
                this@CenterSearchListActivity,
                lat
            )
        }
...
//                toast(it.message ?: getString(R.string.something_went_wrong))
        ...
        val dis = RxTextView.textChanges(etSelectTrainer)
//            .skipInitialValue()
...
//            .distinctUntilChanged()
    ...
    override fun layout(): Int = R.layout.activity_center_search

    override fun tag(): String = TAG

    private val myRoundedBottomSheet = CenterDetailsDialogFragment()
...
//        }
    ...
    companion object {
        private const val TAG = "CenterSearchListActivity:::  "
    }
