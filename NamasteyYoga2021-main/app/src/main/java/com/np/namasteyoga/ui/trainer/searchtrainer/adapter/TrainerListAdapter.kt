package com.np.namasteyoga.ui.trainer.searchtrainer.adapter
    ...
    inner class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            ...
            share.setOnClickListener {
                list?.get(adapterPosition)?.run {
                    // val data = "Trainer Name: $name\nMobile no: ${phone?.getDecryptData() ?: CommonString.NA}\nEmail Id: ${email?.getDecryptData() ?: CommonString.NA}\nAddress: $address"
...
//            txtDistance.text = itemView.context.getString(R.string.s_km_away, number3digits)
            ...
            txtDistance.text =
               "${ itemView.context.getString(R.string.s_km_away, number3digits.toString())} ${item.city_name?:CommonString.Empty}"
        }
