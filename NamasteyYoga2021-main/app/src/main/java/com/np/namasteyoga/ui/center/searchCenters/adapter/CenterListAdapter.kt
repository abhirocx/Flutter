package com.np.namasteyoga.ui.center.searchCenters.adapter
...
class CenterListAdapter(
    ...
    RecyclerView.Adapter<CenterListAdapter.MyViewHolder>() {
...
//            .inflate(R.layout.center_user_list_item_layout, parent, CommonBoolean.FALSE)
            .inflate(R.layout.center_item_layout, parent, CommonBoolean.FALSE)
...
//            txtDistance.text = itemView.context.getString(R.string.s_km_away, number3digits)
