package com.np.namasteyoga.ui.ayushMerchandise.categoryList.adapter
...
class AyushMerchandiseCatagoryAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.asasa_sub_category_item_layout, parent, false)
