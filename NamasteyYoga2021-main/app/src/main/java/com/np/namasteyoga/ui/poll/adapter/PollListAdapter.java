...
public class PollListAdapter extends RecyclerView.Adapter<PollListAdapter.ViewHolder> {
    ...
    public PollListAdapter(Context context, List<Datum> pollDataList, ItemListener itemListener) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            tvPollName = (TextView) v.findViewById(R.id.tvPollName);
            ivRadio = (ImageView) v.findViewById(R.id.ivRadio);
        }

        public void setData(Datum item) {
            this.data = item;
            tvPollName.setText(UIUtils.INSTANCE.getCapitalized(item.getPollName()));
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.poll_list_item_layout, parent, false);
