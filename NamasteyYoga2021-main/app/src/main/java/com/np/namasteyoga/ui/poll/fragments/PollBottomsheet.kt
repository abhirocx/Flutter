package com.np.namasteyoga.ui.poll.fragments
...
class PollBottomsheet : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.poll_bottomsheet_layout, container, false)
    }
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        return super.onCreateDialog(savedInstanceState).apply {
            setOnShowListener {
                mBehavior = (this@PollBottomsheet.dialog as BottomSheetDialog).behavior
