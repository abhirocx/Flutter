...
import 'newSurveyFamilyMemberAdd.dart';

class SurveyFamilyHeadEdit extends StatefulWidget {
  SurveyFamilyHeadEdit(
    ...
    head_is_divyang = family_head_is_divyang;
  }

  @override
  _SurveyFamilyHeadEditState createState() => _SurveyFamilyHeadEditState();
}
...
class _SurveyFamilyHeadEditState extends State<SurveyFamilyHeadEdit>
  ...
  void initState() {
    ...
    family_head_name.text = decrypt(head_name.toString());
    family_head_address.text = decrypt(head_address.toString());
    family_head_mobile_no.text = decrypt(head_mobile_no.toString());
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Visibility(
                                visible:
                                    ( _selectedValueIndex != null && _selectedValueIndexDivyang!=null&& flag == 1),
                                child: Padding(
                              ...
                              Visibility(
                                ...
                                child: Padding(
                                  ...
                                  child: DropdownButtonFormField(
                                    ...
                                    value: int.parse(head_educationtype),
                                    validator: (value) => value == null
                                        ? Languages.of(context)!
  ...
  Future<ResponseMemberUpdate?> addMember() async {
    ...
    RequestMemberUpdate request = new RequestMemberUpdate(
      id: head_id.toString(),
      fullname: encrypt(family_head_name.text.toString()).base64,
      address: encrypt(family_head_address.text.toString()).base64,
      age: int.parse(family_head_age.text),
      ...
      // vt: family_member_relation.toString(),
            ...
            actions: [
              ...
              TextButton(
                onPressed: () async {
                  Navigator.pop(context);
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => ManageRecord()));
                },
