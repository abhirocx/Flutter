...
class SurveyFamilyMemberEdit extends StatefulWidget {
  SurveyFamilyMemberEdit(
    ...
    m_is_divyang = member_is_divyang;
  }

  @override
  _SurveyFamilyMemberEditState createState() => _SurveyFamilyMemberEditState();
}
...
class _SurveyFamilyMemberEditState extends State<SurveyFamilyMemberEdit>
  ...
  @override
  void initState() {
    family_member_name.text = decrypt(m_name);
    family_member_father.text = (m_father_name.toString());
    family_member_mobile_no.text = decrypt(m_mobile_no);
  ...
  Future<ResponseMemberUpdate?> addMember() async {
    ...
    RequestMemberUpdate request = new RequestMemberUpdate(
      ...
      fatherName: family_member_father.text.toString(),
    ...
    showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            content: Text(Languages.of(context)!.Do_you_want_to_upload_more_member),
            actions: [
              TextButton(
                onPressed: () {
                  Navigator.pop(context);
